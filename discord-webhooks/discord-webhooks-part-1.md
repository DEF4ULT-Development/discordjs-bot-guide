...
.then(webhook => webhook.edit("Example Webhook",{ avatar:"https://i.imgur.com/p2qNFag.png"})
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "createHook")) {
    message.channel.createWebhook("Example Webhook",{
    avatar:"https://i.imgur.com/p2qNFag.png"})
      .then(webhook => webhook.edit("Example Webhook",{ avatar:"https://i.imgur.com/p2qNFag.png"})
...
message.channel.createWebhook(name, {avatar:avatar})
  .then(webhook => webhook.edit(name, {avatar:avatar})
